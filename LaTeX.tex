...
\section{Useful Tips}
%\begin{center}
%  \bf{\Huge{The Basics (cont.)}}
%\end{center}
\LARGE Here are some useful tips... \\\\
\Large
Single line comments are denoted with a \%, whereas block comments are handled with
\begin{verbatim}
    \begin{comment}
        This is a multi
        line comment
    \end{comment}
\end{verbatim}
In order to add \LaTeX\ to your document without having it interpreted as \LaTex, you can use the in-line 
\begin{verbatim}
    \verb|<LaTeX goes here>|    
\end{verbatim}
These special characters, if simply placed in-line, will not print and will cause unintended results.
\begin{center}
\# \$ \% \^{} \& \_ \{ \} \~{} \textbackslash
\end{center}
In order to insert them, use these instead
\begin{verbatim}
\# \$ \% \^{} \& \_ \{ \} \~{} \textbackslash
\end{verbatim}
You can break up your \LaTeX\ document into sections, subsections, subsubsections, paragraphs, and subparagraphs in the article class. In the report and book classes, they can also have chapters. For example,
\begin{verbatim}
\section{<Section Name>}
\end{verbatim}
will create a section with the name Section Name. To create a table of contents, simply insert \verb|\tableofcontents| in a new page in the beginning of your document.
